...
%% :-['/var/lib/myfrdcsa/codebases/minor/free-life-planner/projects/pddl/prolog-pddl-parser/prolog-pddl-3-0-parser-20140825/parseDomainPDDL2.2']. %make sure that it is loaded.
...
:- ensure_loaded('sharedPDDL2.2Problem.pl').