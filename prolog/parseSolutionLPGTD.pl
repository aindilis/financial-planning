...
:- ensure_loaded('readFileI.pl').
%% :- ensure_loaded('/var/lib/myfrdcsa/codebases/minor/agent-attempts/7/parser/pddl/2.2/sharedPDDL2.2.pl').
...
parseSolution(F, O):-
	...
	atomic_list_concat(['/var/lib/myfrdcsa/codebases/minor/agent-attempts/7/scripts/trim.pl','-f',F,'>',F2],' ',Command),
	shell(Command,_),
	%% parseSolution(F, O, _).
...
%% commandLine(CLI)        --> ['/var/lib/myfrdcsa/codebases/internal/verber/data/planner-library/lpg-td-1.0 -o hygiene.d.pddl -f hygiene.p.pddl -out /var/lib/myfrdcsa/codebases/internal/verber/data/worldmodel/worlds/hygiene.p.pddl.LPG.sol -speed'].
